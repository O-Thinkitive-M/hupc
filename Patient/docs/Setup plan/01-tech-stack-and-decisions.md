...
| Payments | `@stripe/stripe-js`, `@stripe/react-stripe-js` | ✅ Billing & Payments feature |
| Insurance-card OCR | OCR SDK/lib (TBD) | – not used by Patient |
| Telehealth | Google Meet integration lib (TBD) | ✅ Telehealth feature |
