...
> **Patient** portal. Config values (nav modules, route maps, status registries, permissions,
...
|---|---|
| Dashboard / home strip | KpiCard grid |
| Appointments scheduler | Calendar + TimeSlotGrid |
| Intake / Profile (Create/Edit) | SchemaForm + FormSection |
| Messaging | MessageList / Thread + Composer |
| Documents / Health Records | DocumentViewer + DocumentLibrary |
| Billing & Payments | DataTable (invoices) + Stripe payment element |
| Telehealth visit | Video panel |
| Notifications / Profile settings | SettingsHub + List |
...
| 5. Features | Assemble **10 modules** from config + primitives (file 20 + features) |
